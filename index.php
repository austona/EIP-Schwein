...
<div id="header">
  ...
  <!-- <div class="container header"> -->
    ...
    <header>
      <div class="logo">
	  <a target="_blank" href="https://www.netzwerk-laendlicher-raum.de/themen/eip-agri/"><img src="images/eip_logo_trans.png"  alt=""/></a>
	  </div>
      <div class="mainmenu">
        <div id="mainmenu">
          <ul class="sf-menu">
...
<div id = "main" style = "background: #e4eda8; z-index: 1;">
<!-- Home Content Part - Slider ==================================================
================================================== -->
<div class = "container">
<div class="flexslider">
  <ul style = "margin: auto;"class="slides">
    <li> <a  href="#"><img src="images/innovative_maßnahmen/verspruehung.png" alt=""/></a> 
	<!--<div class = "sepContainerSlider"> </div>-->
	 ...
	 In der Nähe des Kotbereichs angebracht hilft sie zudem, dass diese im gewünschten Bereich, z.B. im Bereich mit Spaltenboden 
	...
	<p> 
	Ein großzügiges Tier-Fressplatz Verhältnis ermöglicht synchrones fressen und führt zu weniger Rangauseinandersetzungen. 
	Insbesondere bei Verzicht auf Schwanzkupieren ist dies von großer Bedeutung. 
	</p>
	</div>
	</li>
	...
	<p> 
	Eine Hochdruckvernebelung ermöglicht eine schnelle Kühlung der Stalluft ohne Stall und Tiere zu sehr einzunässen.
	Zudem bindet Sie Staub aus der Luft, was besonders bei der Nutzung von Einstreu die Stalluft verbessert.  </p>
	</div>
    </li>
  </ul>
</div>
...
<div class = "container scheme_map">
 ...
 <h2> Ablaufschema </h2>
	<!-- Trigger the Modal -->
	<img id="ablaufschema" src="images/home/schaubild.png" alt="Schaubild" width= "100%" height="100%">
...
<h2> Gesellschaftliche Anforderungen </h2>
<!-- Trigger the Modal -->
	<img id="karte" src="images/home/schaubild_gesellschaft.png" alt="Karte" width= "100%" height="100%">
	...
	<!-- Modal Caption (Image Text) -->
	<div id="captionKarte">
	<p>Die gesellschaftlichen Anforderungen an die Landwirtschaft nehmen weiter zu nachdem vergangene Herausforderungen bereits erfolgreich 
	bewältigt wurden. Lebensmittel waren nie zuvor so sicher und stehen heute in ausreichender Menge für 
	jeden Geldbeutel zur Verfügung, zudem waren Tierverluste noch nie so gering wie heute. Nun sieht sich
	die Landwirtschaft jedoch neuen Anforderungen gegenüber. 
 </p></div>
	</div>
