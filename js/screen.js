...
//##########################################
	...
	//##########################################
		// Get the modal
var modal = document.getElementById('ablaufschemaModal');

// Get the image and insert it inside the modal - use its "alt" text as a caption
var img = document.getElementById('ablaufschema');
var modalImg = document.getElementById("imgAblaufschema");
var captionText = document.getElementById("captionAblaufschema");
...
var modalImg = document.getElementById("imgKarte");
var captionText = document.getElementById("captionKarte");
img.onclick = function(){
    modal.style.display = "block";
    modalImg.src = this.src;
    captionText.innerHTML = this.alt;
